            ...
            public function animalSearchCard($site_data){
                ...
                echo "<div class='form_container inline'>";
                    ...
                    echo "<form name='search_livestock' class='js_form' data-action='search_livestock'>";
                        echo "<div>";
                            $form_element -> text('free_text', 'Text (name/tag)', false, '', '');
                            $form_element -> submit('Search');
                        echo "</div>";
                    echo "</form>";
                echo "</div>";
                ...
                echo "<div class='form_container add_livestock form_hide'>";
                    ...
                    echo "<form name='add_livestock' class='js_form col_3' data-action='add_livestock'>";
                            echo "<div>";
                                ...
                                $form_element -> text('livestock_name', 'Name', false, '', '');
                                $form_element -> select('species', 'Species', true, 'required', 'Please select a species', $species_list);
                                $form_element -> selectDisabled('breed', 'Breed', true, 'required', 'Please select a breed', $breed_list -> html);
                                $form_element -> text('uk_tag_no', 'Tag', true, 'required', 'Please add a tag number');
                                $form_element -> textarea('origin', 'Origin', false, '', '');
                            echo "</div>";
                            echo "<div>";
                                echo "<p class='form_blank'></p>";
                                $form_element -> date('date_of_birth', 'Date of birth', false, '', '');
                                $form_element -> date('date_of_death', 'Date of death', false, '', '');
                                $form_element -> date('date_of_sale', 'Date of sale', false, '', '');
                                $form_element -> text('pedigree_no', 'Pedigree number', false, '', '');
                                $form_element -> textarea('livestock_notes', 'Notes', false, '', '');
                            echo "</div>";
                        echo "<div>";
                            echo "<p class='form_blank'></p>";
                            $form_element -> select('gender', 'Gender', true, 'required', 'Please select a gender', $gender_list);
                            $form_element -> selectDisabled('mother', 'Mother', false, '', '', $mothers_list -> html);
                            $form_element -> selectDisabled('father', 'Father', false, '', '', $fathers_list -> html);
                            $form_element -> checkbox('home_bred', 'Home bred');
                            $form_element -> checkbox('for_slaughter', 'For slaughter');
                        echo "</div>";
                        echo "<div class='fullWidth'>";
                            $form_element -> submit('Add Livestock');
                        echo "</div>";
                    echo "</form>";
                echo "</div>";
            }
                ...
                echo "<div class='form_container edit_livestock form_hide'>";
                    ...
                    echo "<form name='edit_livestock' class='col_3 js_form' data-action='edit_livestock'>";
                            echo "<div>";
                                ...
                                $form_element -> select('breed', 'Breed', true, 'required', 'Please select a breed', $breed_list -> html);
                                $form_element -> text('uk_tag_no', 'Tag', true, 'required', 'Please enter a tag number');
                                $form_element -> textarea('origin', 'Origin', false, '', '');
                            echo "</div>";
                            echo "<div>";
                                echo "<p class='form_blank'></p>";
                                $form_element -> date('date_of_birth', 'Date of birth', true, 'required', 'Please enter a date of birth');
                                $form_element -> date('date_of_death', 'Date of death', false, '', '');
                                $form_element -> date('date_of_sale', 'Date of sale', false, '', '');
                                $form_element -> text('pedigree_no', 'Pedigree number', false, '', '');
                                $form_element -> textarea('livestock_notes', 'Notes', false, '', '');
                        ...
                        echo "<div>";
                            echo "<p class='form_blank'></p>";
                            $form_element -> select('gender', 'Gender', true, 'required', 'Please select a gender', $generic -> getGenderList());
                            $form_element -> select('mother', 'Mother', false, '', '', $mothers_list -> html);
                            $form_element -> select('father', 'Father', false, '', '', $fathers_list -> html);
                            $form_element -> checkbox('home_bred', 'Home bred');
                            $form_element -> checkbox('for_slaughter', 'For slaughter');
                        echo "</div>";
                        echo "<div class='fullWidth'>";
                            $form_element -> submit('Edit Livestock');
                        echo "</div>";
                    echo "</form>";
                echo "</div>";
            }
