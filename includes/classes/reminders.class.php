                ...
                echo "<div class='form_container add_reminder form_hide'>";
                    ...
                    echo "<form name='add_reminder' class='col_2 js_form' data-action='add_reminder'>";
                        echo "<div>";
                            ...
                            $form_element -> textarea('description', 'Notes', true, 'required', 'Please enter some notes');
                            $form_element -> checkboxCompact('before_1m', 'Remind me 1 month before');
                            $form_element -> checkboxCompact('before_1w', 'Remind me 1 week before');
                            $form_element -> checkboxCompact('before_1d', 'Remind me 1 day before');
                        echo "</div>";
                        echo "<div>";
                            echo "<p class='form_blank'></p>";
                            $form_element -> select('priority', 'Priority (5 is highest)', false, '', '',$priorityList);
                            $form_element -> textarea('emails', 'Email recipients (separate with comma)', false, '', '');
                            $form_element -> checkboxCompact('after_m', 'After, remind me monthly');
                            $form_element -> checkboxCompact('after_w', 'After, remind me weekly');
                            $form_element -> checkboxCompact('after_d', 'After, Remind me daily');
                        echo "</div>";
